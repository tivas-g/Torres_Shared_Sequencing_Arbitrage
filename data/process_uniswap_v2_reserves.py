    ...
    for chain in CHAINS:
        ...
        for date in dates:
            ...
            if not os.path.exists("uniswap_v2/"+chain+"/"+chain+"_uniswap_v2_events_"+str(date[0])+"_"+"{:02d}".format(date[1])+"_"+"{:02d}".format(date[2])+".json"):
                print("Error file 'uniswap_v2/"+chain+"/"+chain+"_uniswap_v2_events_"+str(date[0])+"_"+"{:02d}".format(date[1])+"_"+"{:02d}".format(date[2])+".json' is missing!")
                sys.exit(-1)
            
            print("Searching for reserve updates within:", "uniswap_v2/"+chain+"/"+chain+"_uniswap_v2_events_"+str(date[0])+"_"+"{:02d}".format(date[1])+"_"+"{:02d}".format(date[2])+".json")
            with open("uniswap_v2/"+chain+"/"+chain+"_uniswap_v2_events_"+str(date[0])+"_"+"{:02d}".format(date[1])+"_"+"{:02d}".format(date[2])+".json", 'r') as f:
                events = json.load(f)
